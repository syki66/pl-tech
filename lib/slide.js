        ...
        while (i < datalist.length) {
            list =
                ...
                `<div class="check-box__items">
                    <input class="check-box" type="checkbox" id="check${i+1}" name="check${i+1}" value="${datalist[i]}" onchange="checkBox(this)">
                    <label for="check${i+1}">
                ...
                <p><input class="check-box" type="hidden" id="check${i+1}Hidden" name="check${i+1}" value=null></p>`;
            i = i + 1;
        }
        list = list + `
            <div class="check-box__items">
                        ...
                        <h2>슬라이드 및 뉴스탭 관리</h2>
                            ...
                            <div class="inner-container">
                                <div class="inner-container__1">
                                    <form class="form__1" name="check" action="/admin/slide" method="post" onsubmit="checking()">
                ...
                function checking(){
                    for(var i = 1 ; i <= 9; i = i + 1){
                        if(document.getElementById("check"+i).checked) {
                            document.getElementById('check'+i+'Hidden').disabled = true;
                        }else{
                            document.getElementById('check'+i+'Hidden').disabled = false;
                        }
                    }
                } 
                </script>
