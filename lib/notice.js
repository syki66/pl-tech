                ...
                <div class="container">
                    ...
                    <div class="inner__container">
                        ...
                        <form action ="/admin/notice/${id}/uprocess?_method=patch" method="post"> 
                            ...
                            <input class="input__1" name="title" type="text" value="${title}" placeholder="제목을 입력하세요 (50자 제한)" maxlength="50">
                            <textarea class="input__2" name="contents" placeholder="내용을 입력하세요 (5000자 제한)" maxlength="5000">${contents}</textarea>
