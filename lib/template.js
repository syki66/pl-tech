...
module.exports = {
    ...
    noticeList: function (datalist) {
        var list = '<ul><li><div class="board__date">날짜</div><div class="link__container title">제목</div></li>';
        var i = 0;
        while (i < datalist.length) {
            var cdate = util.cdateParser(datalist[i].cdate);
            list = list + `<li>
                                <div class="board__date">${cdate.date} (${cdate.week})</div><div class="link__container"> <a class="board__link" href="/board/${datalist[i].id}">${datalist[i].title}</a></div>
                        </li>`;
            i = i + 1;
    ...
    m_noticeList: function (datalist) {
        ...
        var list = '<ul><li><div class="link__container title">제목</div><div class="board__form">삭제</div></li>';
        var i = 0;
        while (i < datalist.length) {
