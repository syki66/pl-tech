                            ...
                            <div class="inner-container__2">
                                <form class="form__2">
                                    <div class="slide-rotation">
                                        ...
                                        <div class="time-input"><input name="title" type="text" placeholder="H">시</div>
                                        <div class="time-input"><input name="title" type="text" placeholder="M">분</div>
                                        <div class="time-input"><input name="title" type="text" placeholder="S">초</div>
                                    </div>
