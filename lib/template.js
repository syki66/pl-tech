...
module.exports = {
    ...
    m_workerManage: function (leader, staff1, staff2, staff3) {
        ...
        <head>
            ...
            .input__1{
                top: calc(var(--width) / 100 * 3);
            }
            .input__2{
                top: calc(var(--width) / 100 * 7);
            }
            .input__3{
                top: calc(var(--width) / 100 * 11);
            }

            .input__5{
                left: calc(var(--width) / 100 * 11);
            }
            ...
            <div class="add__container">
                ...
                <form action="/admin/wmanage/upload" method="post" enctype="multipart/form-data">
                    ...
                    <p>
                        ...
                        <input class="input__5" type="submit" value="업로드"></p>
                </form>
            </div>
        </div>
