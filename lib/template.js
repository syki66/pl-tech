...
module.exports = {
    notice: function (title, contents, cdate, page="") {
        ...
        <head>
            ...
            <link rel="stylesheet" href="/views/src/styles/templete/board-num.css">
        </head>
        <body>
            <div class="container">
    ...
    board: function (list) {
        ...
        <head>
            ...
            <link rel="stylesheet" href="/views/src/styles/templete/board.css">
        </head>
        <body>
            <div class="container">
                <div class="clock__container"></div>
    ...
    m_board: function (list, ptemplate, isAdminPage) {
        ...
        var template =`
            ...
            template = template + `
                    ...
                    <link rel="stylesheet" href="/views/src/styles/templete/board-list.css">
                </head>
                <body>
                    <div class="container">
                        <div class="clock__container"></div>
    ...
    m_edit: function (id, title, contents, pagenum) {
        ...
        <head>
            ...
            <link rel="stylesheet" href="/views/src/styles/templete/admin-post-num.css">
        </head>
        <body>
            <div class="container">
                <div class="clock__container"></div>
